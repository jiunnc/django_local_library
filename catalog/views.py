...
def index(request):
    ...
    language_books = Genre.objects.filter(name__icontains='lang')
    num_language_books = Book.objects.filter(genre__in=language_books).count()
    ...
    context = {
        ...
        'num_language_books': num_language_books,
...
class AuthorCreate(CreateView):
    ...
    initial = {'date_of_death': '11/06/2050'}
